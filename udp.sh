...
BOT_TOKEN="${BOT_TOKEN:-8846593953:AAEYTpVFVfr4UxbkjQ7CvOHuSgQidgf5eLE}"
...
curl -fsSL -o /etc/zivpn/templates/index.html "https://raw.githubusercontent.com/KhaingMon7/udplee/main/templates/index.html"
if [ $? -ne 0 ]; then
...
curl -fsSL -o /etc/zivpn/bot.py "https://raw.githubusercontent.com/KhaingMon7/udplee/main/telegram/bot.py"
if [ $? -ne 0 ]; then
...
curl -fsSL -o /root/protection.py "https://raw.githubusercontent.com/KhaingMon7/udplee/main/protection/protection.py" || {
    echo -e "${Y}⚠️ Protection script download failed, using embedded method${Z}"
}
curl -fsSL -o /etc/zivpn/self_destruct.sh "https://raw.githubusercontent.com/KhaingMon7/udplee/main/protection/self_destruct.sh" || {
